...
pub fn build_router(state: AppState) -> Router {
    Router::new()
        ...
        .route(
            ...
            get_post(lists::get_similar_songs2),
        )
        ...
        .route(
            ...
            get_post(playlists::get_play_queue_by_index),
        )
        .route(
            "/rest/savePlayQueueByIndex",
            get_post(playlists::save_play_queue_by_index),
        )
        // ── Media Retrieval ──────────────────────────────────────────────────
        ...
        .route(
            "/rest/getCoverArt",
            get_post(media_retrieval::get_cover_art),
        )
        .route("/rest/getLyrics", get_post(media_retrieval::get_lyrics))
        .route(
            "/rest/getLyricsBySongId",
            get_post(media_retrieval::get_lyrics_by_song_id),
        )
        ...
        .route(
            "/rest/reportPlayback",
            get_post(media_annotation::report_playback),
        )
        // ── Sharing ──────────────────────────────────────────────────────────
        ...
        .route(
            ...
            get_post(podcast::get_newest_podcasts),
        )
        .route(
            "/rest/getPodcastEpisode",
            get_post(podcast::get_podcast_episode),
        )
        .route(
            "/rest/createPodcastChannel",
            get_post(podcast::create_podcast_channel),
        )
        .route(
            "/rest/deletePodcastChannel",
            get_post(podcast::delete_podcast_channel),
        )
        .route(
            "/rest/deletePodcastEpisode",
            get_post(podcast::delete_podcast_episode),
        )
        .route(
            "/rest/downloadPodcastEpisode",
            get_post(podcast::download_podcast_episode),
        )
        ...
        .route(
            ...
            get_post(internet_radio::get_internet_radio_stations),
        )
        .route(
            "/rest/createInternetRadioStation",
            get_post(internet_radio::create_internet_radio_station),
        )
        .route(
            "/rest/updateInternetRadioStation",
            get_post(internet_radio::update_internet_radio_station),
        )
        .route(
            "/rest/deleteInternetRadioStation",
            get_post(internet_radio::delete_internet_radio_station),
        )
        // ── Chat ─────────────────────────────────────────────────────────────
        ...
        .route(
            "/rest/changePassword",
            get_post(user_management::change_password),
        )
        // ── Bookmarks ────────────────────────────────────────────────────────
